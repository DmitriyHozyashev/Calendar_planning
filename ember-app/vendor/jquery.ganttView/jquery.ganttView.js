...
(function (jQuery) {
	...
	var Chart = function(div, opts) {
        ...
        function addHzHeader(div, dates, cellWidth) {
            ...
            var totalW = 0;
			dates.forEach(function(element, y) {
				dates[y].forEach(function(element, m) {
					...
					dates[y][m].forEach(function(element, d) {
	...
	var Behavior = function (div, opts) {
        ...
        function bindBlockClick(div, callback) {
            jQuery(div).on("click", "div.ganttview-block", function () {
